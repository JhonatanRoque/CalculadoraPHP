...
class MathHelp_jmd{
		  ...
		  public static function operations_count($string){
	   	    $nop = 0;
		...
		public static function getOpp($string){
			$opp=""; $n = 0;	
		  ...
		  public static function singleOperation($numbers){ 
		 ...
		 public static function multiOperations($data,$nop){
			$string = $data;
         ...
         public static function calculate_str($string){
		    $nop = 0;
			$result = 0;
